...
WCNSS_PERSIST:= $(TARGET_OUT_ETC)/firmware/wlan/prima/WCNSS_qcom_wlan_factory_nv.bin
$(WCNSS_PERSIST): $(LOCAL_INSTALLED_MODULE)
        @echo "WCNSS_qcom_wlan_factory_nv.bin Firmware link: $@"
        @mkdir -p $(dir $@)
        @rm -rf $@
        $(hide) ln -sf /persist/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(WCNSS_PERSIST)
