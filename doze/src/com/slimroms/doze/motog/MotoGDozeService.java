...
public class MotoGDozeService extends Service {
    private static final String TAG = "MotoGDozeService";
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "MotoGDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new OnePlusProximitySensor(mContext);
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "MotoGDozeWakeLock");
